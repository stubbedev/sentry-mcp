...
if (process.env.SENTRY_MCP_SKIP_DOWNLOAD === '1') {
  process.exit(0);
}
...
try {
  ...
  console.error(`[sentry-mcp] postinstall: ${err.message}`);
  console.error('[sentry-mcp] The binary will be fetched on first run instead.');
}
